...
export type { CollaborationManager } from "./contracts/CollaborationManager";
export { CollaborationManager__factory } from "./factories/contracts/CollaborationManager__factory";
export type { LikeRegistry } from "./contracts/LikeRegistry";
export { LikeRegistry__factory } from "./factories/contracts/LikeRegistry__factory";
export type { LyricsNFT } from "./contracts/LyricsNFT";
export { LyricsNFT__factory } from "./factories/contracts/LyricsNFT__factory";
export type { LyricsRegistry } from "./contracts/LyricsRegistry";
export { LyricsRegistry__factory } from "./factories/contracts/LyricsRegistry__factory";
export type { IERC20Like } from "./contracts/RevenueSplit.sol/IERC20Like";
export { IERC20Like__factory } from "./factories/contracts/RevenueSplit.sol/IERC20Like__factory";
export type { RevenueSplit } from "./contracts/RevenueSplit.sol/RevenueSplit";
export { RevenueSplit__factory } from "./factories/contracts/RevenueSplit.sol/RevenueSplit__factory";
export type { VoteContract } from "./contracts/VoteContract";
export { VoteContract__factory } from "./factories/contracts/VoteContract__factory";
