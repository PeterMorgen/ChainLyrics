...
export declare namespace LyricsNFT {
  export type MetadataStruct = {
    songId: BigNumberish;
    title: string;
    finalVersionCID: string;
...
export interface LyricsNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export namespace MintedEvent {
  export type InputTuple = [tokenId: BigNumberish, songId: BigNumberish];
  export type OutputTuple = [tokenId: bigint, songId: bigint];
  export interface OutputObject {
    tokenId: bigint;
    songId: bigint;
  }
...
export interface LyricsNFT extends BaseContract {
  connect(runner?: ContractRunner | null): LyricsNFT;
  waitForDeployment(): Promise<this>;

  interface: LyricsNFTInterface;
  ...
  getMetadata: TypedContractMethod<
    [tokenId: BigNumberish],
    [LyricsNFT.MetadataStructOutput],
    "view"
  >;
  ...
  filters: {
    ...
    "Minted(uint256,uint256)": TypedContractEvent<
      MintedEvent.InputTuple,
      MintedEvent.OutputTuple,
      MintedEvent.OutputObject
    >;
