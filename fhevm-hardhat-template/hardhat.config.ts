...
const SEPOLIA_RPC: string = vars.get("SEPOLIA_RPC", "https://ethereum-sepolia-rpc.publicnode.com");
...
const config: HardhatUserConfig = {
  ...
  gasReporter: { currency: "USD", enabled: process.env.REPORT_GAS ? true : false },
  networks: {
    hardhat: {
